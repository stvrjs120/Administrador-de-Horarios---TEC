...
public class clsMetodes {
	 ...
	 * @uml.associationEnd multiplicity="(0 -1)" ordering="true" inverse="clsMetodes:pkgClasses.clsSemester"
	 ...
	 * @uml.associationEnd multiplicity="(0 -1)" ordering="true" inverse="clsMetodes:pkgClasses.clsClassroom"
	 * @uml.association name="contains"
	 */
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" inverse="clsMetodes:pkgClases.clsFaculty"
	 * @uml.association  name="contains"
	 */
	 ...
	 * @param location
	 */
	public void insertClassroom(int pCapacity, String classroomName, int pClassroomNumber, String location){
	}
